...
#___________________________________________________________________________________________________ __init__
    def __init__(self, parent, **kwargs):
        ...
        self._settings = FlexProjectData(
            ArgsUtils.get('targetPath', None, kwargs),
            ArgsUtils.get('projectPath', None, kwargs)
        )
...
#___________________________________________________________________________________________________ _internalMethod
    def _runImpl(self):
        ...
        cmd = [
            ...
            'install',
            '-r',
            FileUtils.createPath(sets.targetPath, sets.targetFilename + '.apk')
        ]
